...
#ifdef _WIN32
#include "ship/speechsynthesizer/SAPISpeechSynthesizer.h"
#elif defined(__APPLE__)
#include "ship/speechsynthesizer/DarwinSpeechSynthesizer.h"
#endif

#include "ship/speechsynthesizer/SpeechLogger.h"
